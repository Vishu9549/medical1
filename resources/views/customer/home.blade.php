  ...
  <div class="scroll" style="flex:1; padding-bottom:8px;">
    ...
    <div style="display:flex; gap:10px; margin-bottom:16px; padding:0 16px;">
      <div style="flex:1; background:#fff; border-radius:12px; padding:10px 6px; text-align:center; box-shadow:0 2px 8px rgba(0,0,0,0.04); border:1px solid #F0F4FF; display:flex; flex-direction:column; align-items:center; justify-content:center;">
        ...
        <div style="font-size:10px; color:#666; font-weight:700; margin-top:2px;">Medical Shops</div>
      </div>
      <div style="flex:1; background:#fff; border-radius:12px; padding:10px 6px; text-align:center; box-shadow:0 2px 8px rgba(0,0,0,0.04); border:1px solid #F0F4FF; display:flex; flex-direction:column; align-items:center; justify-content:center;">
        <div style="font-size:18px; margin-bottom:4px;">🟢</div>
        <div style="font-size:18px; font-weight:900; color:#059669; line-height:1.2;">{{ $onlineShopsCount }}</div>
        <div style="font-size:10px; color:#666; font-weight:700; margin-top:2px;">Online Now</div>
      </div>
      <div style="flex:1; background:#fff; border-radius:12px; padding:10px 6px; text-align:center; box-shadow:0 2px 8px rgba(0,0,0,0.04); border:1px solid #F0F4FF; display:flex; flex-direction:column; align-items:center; justify-content:center;">
        <div style="font-size:18px; margin-bottom:4px;">📍</div>
        <div style="font-size:18px; font-weight:900; color:#D97706; line-height:1.2;">5km</div>
        <div style="font-size:10px; color:#666; font-weight:700; margin-top:2px;">Coverage</div>
      </div>
    </div>
